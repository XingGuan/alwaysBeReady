/* Zepto v1.2.0-29-g3172e92 - zepto event ajax form ie detect fx fx_methods assets data deferred callbacks selector touch gesture stack ios3 - zeptojs.com/license */ ! function (t, e) {
    ...
    var e = function () {
        ...
        function H(t, i, r) {
            for (n in i) r && (R(i[n]) || M(i[n])) ? (R(i[n]) && !R(t[n]) && (t[n] = {}), M(i[n]) && !M(t[n]) && (t[n] = []), H(t[n], i[n], r)) : i[n] !== e && (t[n] = i[n])
        }
    ...
    return t.Zepto = e, void 0 === t.$ && (t.$ = e),
        function (e) {
            ...
            function S(t, n) {
                if (n || !t.isDefaultPrevented) {
                    ...
                    } catch (r) {}(n.defaultPrevented !== i ? n.defaultPrevented : "returnValue" in n ? n.returnValue === !1 : n.getPreventDefault && n.getPreventDefault()) && (t.isDefaultPrevented = x)
                }
                return t
            }
        ...
        function (e) {
            ...
            h.href = t.location.href, e.active = 0, e.ajaxJSONP = function (r, o) {
                ...
                return o && o.promise(h), e(u).on("load error", function (n, i) {
                    clearTimeout(p), e(u).off().remove(), "error" != n.type && c ? y(c[0], h, r, o) : b(null, i || "error", h, r, o), t[s] = f, c && e.isFunction(f) && f(c[0]), f = c = void 0
                ...
                if (s && s.promise(O), a.crossDomain || x("X-Requested-With", "XMLHttpRequest"), x("Accept", d || "*/*"), (d = a.mimeType || d) && (d.indexOf(",") > -1 && (d = d.split(",", 2)[0]), O.overrideMimeType && O.overrideMimeType(d)), (a.contentType || a.contentType !== !1 && a.data && "GET" != a.type.toUpperCase()) && x("Content-Type", a.contentType || "application/x-www-form-urlencoded"), a.headers)
                ...
                if (O.setRequestHeader = x, O.onreadystatechange = function () {
                        if (4 == O.readyState) {
                            ...
                            if (O.status >= 200 && O.status < 300 || 304 == O.status || 0 == O.status && "file:" == C) {
                                if (c = c || T(a.mimeType || O.getResponseHeader("content-type")), "arraybuffer" == O.responseType || "blob" == O.responseType) t = O.response;
                                else {
                                    t = O.responseText;
                                    try {
                                        t = w(t, c, a), "script" == c ? (1, eval)(t) : "xml" == c ? t = O.responseXML : "json" == c && (t = l.test(t) ? null : e.parseJSON(t))
                                    } catch (i) {
                                        n = i
                                    }
        ...
        function (t) {
            function e(t, e) {
                ...
                (i.webkit = !!r) && (i.version = r[1]), o && (n.android = !0, n.version = o[2]), f && !u && (n.ios = n.iphone = !0, n.version = f[2].replace(/_/g, ".")), s && (n.ios = n.ipad = !0, n.version = s[2].replace(/_/g, ".")), u && (n.ios = n.ipod = !0, n.version = u[3] ? u[3].replace(/_/g, ".") : null), h && (n.wp = !0, n.version = h[1]), c && (n.webos = !0, n.version = c[2]), p && (n.touchpad = !0), g && (n.blackberry = !0, n.version = g[2]), v && (n.bb10 = !0, n.version = v[2]), y && (n.rimtabletos = !0, n.version = y[2]), b && (i.playbook = !0), d && (n.kindle = !0, n.version = d[1]), m && (i.silk = !0, i.version = m[1]), !m && n.android && t.match(/Kindle Fire/) && (i.silk = !0), x && (i.chrome = !0, i.version = x[1]), w && (i.firefox = !0, i.version = w[1]), E && (n.firefoxos = !0, n.version = E[1]), T && (i.ie = !0, i.version = T[1]), j && (a || n.ios || l) && (i.safari = !0, n.ios || (i.version = j[1])), S && (i.webview = !0), n.tablet = !!(s || b || o && !t.match(/Mobile/) || w && t.match(/Tablet/) || T && !t.match(/Phone/) && t.match(/Touch/)), n.phone = !(n.tablet || n.ipod || !(o || f || c || g || v || x && t.match(/Android/) || x && t.match(/CriOS\/([\d.]+)/) || w && t.match(/Mobile/) || T && t.match(/Touch/)))
            }
        ...
        function (t, e) {
            ...
            o.style.transform === e && t.each(r, function (t, r) {
                ...
                var b, w, S, x = {},
                    ...
                    C = !1;
                if (i === e && (i = t.fx.speeds._default / 1e3), y === e && (y = 0), t.fx.off && (i = 0), "string" == typeof n) x[h] = n, x[p] = i + "s", x[m] = y + "s", x[d] = r || "linear", j = t.fx.animationEnd;
                else {
                    w = [];
                    for (b in n) a.test(b) ? E += b + "(" + n[b] + ") " : (x[b] = n[b], w.push(v(b)));
                    E && (x[s] = E, w.push(s)), i > 0 && "object" == typeof n && (x[u] = w.join(", "), x[f] = i + "s", x[l] = y + "s", x[c] = r || "linear")
                }
                return S = function (e) {
        ...
        function (e) {
            ...
            function w(w) {
                ...
                x(), h = w && "down" in w ? w : "ontouchstart" in document ? {
                    ...
                    (!(O = b(t, "down")) || y(t)) && (C = O ? t : t.touches[0], t.touches && 1 === t.touches.length && n.x2 && (n.x2 = void 0, n.y2 = void 0), E = Date.now(), T = E - (n.last || E), n.el = e("tagName" in C.target ? C.target : C.target.parentNode), i && clearTimeout(i), n.x1 = C.pageX, n.y1 = C.pageY, T > 0 && 250 >= T && (n.isDoubleTap = !0), n.last = E, a = setTimeout(m, s), u && O && u.addPointer(t.pointerId))
                }, l = function (t) {
                    (!(O = b(t, "move")) || y(t)) && (C = O ? t : t.touches[0], g(), n.x2 = C.pageX, n.y2 = C.pageY, S += Math.abs(n.x1 - n.x2), j += Math.abs(n.y1 - n.y2))
                }, c = function (t) {
                    (!(O = b(t, "up")) || y(t)) && (g(), n.x2 && Math.abs(n.x1 - n.x2) > 30 || n.y2 && Math.abs(n.y1 - n.y2) > 30 ? o = setTimeout(function () {
